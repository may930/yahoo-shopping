...
insert into product values('22', '2', '47', '極冷 爽快汗拭きシート', '一枚で全身すっきり！圧倒的な冷涼感が持続する大判シートです。');
insert into product values('23', '2', '47', 'ポータブル手持ち扇風機 Aero Breeze', '静音設計＆パワフル風量。お出かけに便利な軽量ハンディファン。');
insert into product values('24', '2', '47', '超軽量 遮光率100% 晴雨兼用日傘', '強い日差しを完全にシャットアウト。熱中症対策に最適なコンパクト日傘。');
insert into product values('25', '2', '47', 'プレミアム真空断熱スポーツ魔法瓶', '長時間の保冷力に優れた、アウトドアやスポーツに最適な大容量ボトル。');
insert into product values('26', '2', '47', '冷却ジェルシート 冷えピタ大人用', '急な発熱や、暑くて寝苦しい夜のクールダウンに最適な冷却シート。');
...
insert into product_images values('1', '1', 'localhost/Yahooshopping/Image/ストゼロ500.png', '1');
insert into product_images values('2', '2', 'localhost/Yahooshopping/Image/ストゼロ750.png', '1');
insert into product_images values('3', '3', 'localhost/Yahooshopping/Image/ストゼロドライ.png', '1');
insert into product_images values('4', '4', 'localhost/Yahooshopping/Image/ミネラル550.png', '1');
insert into product_images values('5', '5', 'localhost/Yahooshopping/Image/ミネラル2000.png', '1');
insert into product_images values('6', '6', 'localhost/Yahooshopping/Image/枝豆1.jpg', '1');
insert into product_images values('7', '7', 'localhost/Yahooshopping/Image/枝豆3.jpg', '1');
insert into product_images values('8', '8', 'localhost/Yahooshopping/Image/ソーセージ.webp', '1');
insert into product_images values('9', '9', 'localhost/Yahooshopping/Image/お茶500.jpg', '1');
insert into product_images values('10', '10', 'localhost/Yahooshopping/Image/お茶2000.jpg', '1');
insert into product_images values('11', '11', 'localhost/Yahooshopping/Image/コシヒカリ2.png', '1');
insert into product_images values('12', '12', 'localhost/Yahooshopping/Image/コシヒカリ5.png', '1');
insert into product_images values('13', '13', 'localhost/Yahooshopping/Image/チョコケーキ4.png', '1');
insert into product_images values('14', '14', 'localhost/Yahooshopping/Image/チョコケーキ6.png', '1');
insert into product_images values('15', '15', 'localhost/Yahooshopping/Image/みたらし5.png', '1');
insert into product_images values('16', '16', 'localhost/Yahooshopping/Image/みたらし10.png', '1');
insert into product_images values('17', '17', 'localhost/Yahooshopping/Image/アイス.webp', '1');
insert into product_images values('18', '18', 'localhost/Yahooshopping/Image/岩手丸.png', '1');
insert into product_images values('19', '19', 'localhost/Yahooshopping/Image/海鮮.webp', '1');
insert into product_images values('20', '20', 'localhost/Yahooshopping/Image/肉.webp', '1');
insert into product_images values('21', '21', 'localhost/Yahooshopping/Image/衣類メンズ ダブルブレスト.png', '1');
insert into product_images values('22', '22', 'localhost/Yahooshopping/Image/衣類メンズ ダブルブレスト.png', '1');
insert into product_images values('23', '23', 'localhost/Yahooshopping/Image/衣類メンズ テーラードジャケット.png', '1');
insert into product_images values('24', '24', 'localhost/Yahooshopping/Image/衣類メンズ テーラードジャケット.png', '1');
insert into product_images values('25', '25', 'localhost/Yahooshopping/Image/衣類メンズ ドロップショルダー・ショートジャケット.png', '1');
insert into product_images values('26', '26', 'localhost/Yahooshopping/Image/衣類メンズ ドロップショルダー・ショートジャケット.png', '1');
insert into product_images values('27', '27', 'localhost/Yahooshopping/Image/衣類メンズ ミリタリージャケット.png', '1');
insert into product_images values('28', '28', 'localhost/Yahooshopping/Image/衣類メンズ ミリタリージャケット.png', '1');
insert into product_images values('29', '29', 'localhost/Yahooshopping/Image/衣類レディース オープンショルダーニットワンピース.png', '1');
insert into product_images values('30', '30', 'localhost/Yahooshopping/Image/衣類レディース ビッグカラー.png', '1');
insert into product_images values('31', '31', 'localhost/Yahooshopping/Image/衣類レディース フロントタック.png', '1');
insert into product_images values('32', '32', 'localhost/Yahooshopping/Image/衣類レディース ヘンリーネック.png', '1');
insert into product_images values('33', '33', 'localhost/Yahooshopping/Image/衣類レディース ボリュームスリーブカーディガン.png', '1');
insert into product_images values('34', '34', 'localhost/Yahooshopping/Image/衣類レディース ボリュームスリーブカーディガン.png', '1');
insert into product_images values('35', '35', 'localhost/Yahooshopping/Image/汗拭きシート.webp', '1');
insert into product_images values('36', '36', 'localhost/Yahooshopping/Image/手持ち扇風機.png', '1');
insert into product_images values('37', '37', 'localhost/Yahooshopping/Image/手持ち扇風機.png', '1');
insert into product_images values('38', '38', 'localhost/Yahooshopping/Image/日傘.webp', '1');
insert into product_images values('39', '39', 'localhost/Yahooshopping/Image/魔法瓶.webp', '1');
insert into product_images values('40', '40', 'localhost/Yahooshopping/Image/冷えピタ.webp', '1');
...
insert into product_reviews values('4', '8', '13', '2', '5', '濃厚で本当に美味しい！', '牧場の牛乳の味がしっかりしていて、これ以上の美味しいアイスはないです！家族大満足。', 'localhost/Yahooshopping/Image/アイス.webp', current_timestamp, '45', '15');
insert into product_reviews values('5', '7', '17', '1', '4', 'シルエットが綺麗です', 'ビジネス用に買いました。ダブルブレストのラインがスタイリッシュで気に入っています。少し薄手なので春秋向けですね。', 'localhost/Yahooshopping/Image/衣類メンズ ダブルブレスト.png', current_timestamp, '18', '2');
insert into product_reviews values('6', '11', '36', '4', '5', '夏の必需品です', '寝苦しい夜に貼ると一気に涼しくなり、安眠できます。リピ買い決定です！', 'localhost/Yahooshopping/Image/冷えピタ.webp', current_timestamp, '8', '0');
