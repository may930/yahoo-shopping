...
insert into product_images values('1', '1', 'localhost/yahoo-shopping/Yahooshopping/Image/ストゼロ500.png', '1');

insert into product_images values('2', '2', 'localhost/yahoo-shopping/Yahooshopping/Image/ストゼロ750.png', '1');

insert into product_images values('3', '3', 'localhost/yahoo-shopping/Yahooshopping/Image/ストゼロドライ.png', '1');

insert into product_images values('4', '4', 'localhost/yahoo-shopping/Yahooshopping/Image/ミネラル550.png', '1');

insert into product_images values('5', '5', 'localhost/yahoo-shopping/Yahooshopping/Image/ミネラル2000.png', '1');

insert into product_images values('6', '6', 'localhost/yahoo-shopping/Yahooshopping/Image/枝豆1.jpg', '1');

insert into product_images values('7', '7', 'localhost/yahoo-shopping/Yahooshopping/Image/枝豆3.jpg', '1');

insert into product_images values('8', '8', 'localhost/yahoo-shopping/Yahooshopping/Image/ソーセージ.webp', '1');

insert into product_images values('9', '9', 'localhost/yahoo-shopping/Yahooshopping/Image/お茶500.jpg', '1');

insert into product_images values('10', '10', 'localhost/yahoo-shopping/Yahooshopping/Image/お茶2000.jpg', '1');

insert into product_images values('11', '11', 'localhost/yahoo-shopping/Yahooshopping/Image/コシヒカリ2.png', '1');

insert into product_images values('12', '12', 'localhost/yahoo-shopping/Yahooshopping/Image/コシヒカリ5.png', '1');

insert into product_images values('13', '13', 'localhost/yahoo-shopping/Yahooshopping/Image/チョコケーキ4.png', '1');

insert into product_images values('14', '14', 'localhost/yahoo-shopping/Yahooshopping/Image/チョコケーキ6.png', '1');

insert into product_images values('15', '15', 'localhost/yahoo-shopping/Yahooshopping/Image/みたらし5.png', '1');

insert into product_images values('16', '16', 'localhost/yahoo-shopping/Yahooshopping/Image/みたらし10.png', '1');

insert into product_images values('17', '17', 'localhost/yahoo-shopping/Yahooshopping/Image/アイス.webp', '1');

insert into product_images values('18', '18', 'localhost/yahoo-shopping/Yahooshopping/Image/岩手丸.png', '1');

insert into product_images values('19', '19', 'localhost/yahoo-shopping/Yahooshopping/Image/海鮮.webp', '1');

insert into product_images values('20', '20', 'localhost/yahoo-shopping/Yahooshopping/Image/肉.webp', '1');

insert into product_images values('21', '21', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ ダブルブレスト.png', '1');

insert into product_images values('22', '22', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ ダブルブレスト.png', '1');

insert into product_images values('23', '23', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ テーラードジャケット.png', '1');

insert into product_images values('24', '24', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ テーラードジャケット.png', '1');

insert into product_images values('25', '25', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ ドロップショルダー・ショートジャケット.png', '1');

insert into product_images values('26', '26', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ ドロップショルダー・ショートジャケット.png', '1');

insert into product_images values('27', '27', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ ミリタリージャケット.png', '1');

insert into product_images values('28', '28', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ ミリタリージャケット.png', '1');

insert into product_images values('29', '29', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類レディース オープンショルダーニットワンピース.png', '1');

insert into product_images values('30', '30', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類レディース ビッグカラー.png', '1');

insert into product_images values('31', '31', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類レディース フロントタック.png', '1');

insert into product_images values('32', '32', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類レディース ヘンリーネック.png', '1');

insert into product_images values('33', '33', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類レディース ボリュームスリーブカーディガン.png', '1');

insert into product_images values('34', '34', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類レディース ボリュームスリーブカーディガン.png', '1');

insert into product_images values('35', '35', 'localhost/yahoo-shopping/Yahooshopping/Image/汗拭きシート.webp', '1');

insert into product_images values('36', '36', 'localhost/yahoo-shopping/Yahooshopping/Image/手持ち扇風機.png', '1');

insert into product_images values('37', '37', 'localhost/yahoo-shopping/Yahooshopping/Image/手持ち扇風機.png', '1');

insert into product_images values('38', '38', 'localhost/yahoo-shopping/Yahooshopping/Image/日傘.webp', '1');

insert into product_images values('39', '39', 'localhost/yahoo-shopping/Yahooshopping/Image/魔法瓶.webp', '1');

insert into product_images values('40', '40', 'localhost/yahoo-shopping/Yahooshopping/Image/冷えピタ.webp', '1');
...
insert into product_reviews values('4', '8', '13', '2', '5', '濃厚で本当に美味しい！', '牧場の牛乳の味がしっかりしていて、これ以上の美味しいアイスはないです！家族大満足。', 'localhost/yahoo-shopping/Yahooshopping/Image/アイス.webp', current_timestamp, '45', '15');

insert into product_reviews values('5', '7', '17', '1', '4', 'シルエットが綺麗です', 'ビジネス用に買いました。ダブルブレストのラインがスタイリッシュで気に入っています。少し薄手なので春秋向けですね。', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ ダブルブレスト.png', current_timestamp, '18', '2');

insert into product_reviews values('6', '11', '36', '4', '5', '夏の必需品です', '寝苦しい夜に貼ると一気に涼しくなり、安眠できます。リピ買い決定です！', 'localhost/yahoo-shopping/Yahooshopping/Image/冷えピタ.webp', current_timestamp, '8', '0');
...
-- insert into product_reviews values('2', '4', '5', '2', '4', 'さっぱりしていて美味しい', '普段使いにちょうどいいお茶です。また注文したいです。', 'まだ画像ないです', current_timestamp, '5', '1');
-- insert into product_reviews values('3', '5', '8', '3', '5', 'ふっくら美味しいお米', 'モチモチした食感で、冷めても美味しく食べられました。', 'https://example.com/reviews/kome_review.jpg', current_timestamp, '20', '5');
-- insert into product_reviews values('4', '8', '17', '2', '5', '濃厚で本当に美味しい！', '牧場の牛乳の味がしっかりしていて、これ以上の美味しいアイスはないです！家族大満足。', 'localhost/yahoo-shopping/Yahooshopping/Image/アイス.webp', current_timestamp, '45', '15');
-- insert into product_reviews values('5', '7', '21', '1', '4', 'シルエットが綺麗です', 'ビジネス用に買いました。ダブルブレストのラインがスタイリッシュで気に入っています。少し薄手なので春秋向けですね。', 'localhost/yahoo-shopping/Yahooshopping/Image/衣類メンズ ダブルブレスト.png', current_timestamp, '18', '2');
-- insert into product_reviews values('6', '11', '40', '4', '5', '夏の必需品です', '寝苦しい夜に貼ると一気に涼しくなり、安眠できます。リピ買い決定です！', 'localhost/yahoo-shopping/Yahooshopping/Image/冷えピタ.webp', current_timestamp, '8', '0');
