<?php 
    ...
    if (isset($_SESSION['category_drink_List'])) {
    $category_drink_List = $_SESSION['category_drink_List'];
    }
...
<head>
    ...
    <title>飲み物カテゴリ - HCS!ショッピング</title>
        ...
        <div class="container">
            <div class="ys-main-layout">
                ...
                <div class="product-grid-3" id="ranking-container">
                    <?php foreach ($category_drink_List as $Beans): ?>
                        <?php 
