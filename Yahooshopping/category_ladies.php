<?php 
    ...
    if (isset($_SESSION['category_ladies_List'])) {
    $category_ladies_List = $_SESSION['category_ladies_List'];
    }
...
<head>
    ...
    <title>レディースカテゴリ - HCS!ショッピング</title>
        ...
        <div class="container">
            <div class="ys-main-layout">
                ...
                <div class="product-grid-3" id="ranking-container">
                    <?php foreach ($category_ladies_List as $Beans): ?>
                        <?php 
